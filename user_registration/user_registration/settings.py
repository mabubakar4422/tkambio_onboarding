...
DATABASES = {
    'default': {
        ...
        'NAME': 'tkambio_onboarding',  # Replace with your database name
        'USER': 'millerrivera',  # Replace with your database user
        'PASSWORD': 'Tkambious02_',  # Replace with your password
        'HOST': 'tkambio-us-dabases.mysql.database.azure.com',  # Or your database host
